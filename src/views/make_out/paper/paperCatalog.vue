              ...
              try {
                ...
                ws.forEach((element) => {
                  if (element.catalog == undefined || element.catalog == "") {
                    element.catalog = sessionStorage.getItem("catalog");
                  }
                  if (
                    ...
                    importq
                      ...
                      .then(
                        (res) => {
                          ...
                          if (
                            questions_detail.length == this.excelFile.length &&
                            finish == false
                          ) {
                            let num = 0;
...
.paperCatalog .create .el-radio-group {
  margin-bottom: 10px;
}
.paperCatalog .create .el-select {
  width: 100%;
}
</style>